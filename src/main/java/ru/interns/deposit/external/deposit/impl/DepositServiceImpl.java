...
public class DepositServiceImpl implements DepositService {
    public DepositServiceStatus checkAndOpen(OpenDepositRequestDTO request) {
        ...
        open(OpenDepositRequestDTO.builder().passportNumber(request.getPassportNumber()).build());
        return null;
    }
