...
public enum Errors {
    ...
    USER_MIDDLE_NAME_IS_TOO_SHORT(19),
    USER_MIDDLE_NAME_IS_TOO_LONG(20),
    USER_MIDDLE_NAME_IS_INVALID(21),
    ...
    DEPOSIT_JSON_REQUEST_PARSE_ERROR(30),
    DEPOSIT_USER_DOESNT_HAVE_DEPOSITS(36),
    DEPOSIT_UNKNOWN_ERROR(39);
